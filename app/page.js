  ...
  return (
    <main>
      ...
      <ul className="list-disc list-inside">
        ...
        <li>
          <Link href="./week-6" className={linkClassName}>Week 6</Link>
        </li>

        <li>
          <Link href="./week-7" className={linkClassName}>Week 7</Link>
        </li>

        <li>
          <Link href="./week-8" className={linkClassName}>Week 8</Link>
        </li>
        ...
        <li>
          <Link href="./week-10" className={linkClassName}>Week 10</Link>
        </li>
